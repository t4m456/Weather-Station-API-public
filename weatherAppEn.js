...
//----------------------get the day for FORECAST-------------------//
        ...
        displayForecast(forecastWeather){
          ...
          <h4><span>${myForecast.actualDay}: <span class="data-decor">${myForecast.forecastDate}</span></span> <span>Temperature: </span><span class="data-decor">${myForecast.forecastTemp} &#8451;</span> <span>${myForecast.forecastDescription}</span></h4>
